...
pub const MMapEnt = extern struct {
    ...
    pub inline fn getRawType(self: *const Self) u4 {
...
pub const BOOTBOOT = extern struct {
    ...
    pub inline fn get_mmap_slice(self: *Self) [*]MMapEnt {
        return @ptrCast(@alignCast(&self.mmap));
    }

    pub inline fn num_mmap_entrie(self: *Self) u32 {
